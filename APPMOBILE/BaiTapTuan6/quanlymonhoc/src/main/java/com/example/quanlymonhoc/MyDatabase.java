...
public class MyDatabase extends SQLiteOpenHelper {
    ...
    public static final String COL_MONHOC_IMG = "monhoc_img";
    ...
    public void getMonHocS(ArrayList<MonHoc> monHocs){
        ...
        Cursor cursor  = db.query(TB_MONHOCS,
                new String[]{COL_MONHOC_IMG, COL_MONHOC_MA, COL_MONHOC_TEN,COL_MONHOC_SOTIET},
                null, null, null, null, null);
        if(cursor.moveToFirst()){
            do{
                MonHoc monHoc = new MonHoc();
                monHoc.setImg(cursor.getInt(cursor.getColumnIndex(COL_MONHOC_IMG)));
    ...
    public void saveMonHocs(MonHoc monHoc){
        ...
        values.put(COL_MONHOC_IMG, monHoc.getImg());
